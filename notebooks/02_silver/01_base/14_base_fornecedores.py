...
# MAGIC %md
# MAGIC # Silver Curated Layer — Supplier Enrichment and Validation
# MAGIC
...
# MAGIC
# MAGIC This notebook reads supplier records from Silver Base, prioritizes CNPJ
# MAGIC suppliers based on CEAP expense usage, validates selected CNPJs using public
# MAGIC CNPJ enrichment utilities and creates analytical flags related to supplier
...
# MAGIC - Prioritize CNPJ suppliers based on CEAP usage
...
# MAGIC - Persist Silver Curated Delta table
